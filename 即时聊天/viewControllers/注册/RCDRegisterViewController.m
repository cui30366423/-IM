...
//    return;
  ...
  NSString *nickName =
    ...
    [DCHttpTool registerWithEmail:@"275439676@qq.com" mobile:@"18613955010" userAccount:userName password:userPwd gender:@"1" success:^(id response) {
        int code = [response[responseCode] intValue];
